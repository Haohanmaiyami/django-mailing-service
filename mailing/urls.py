...
urlpatterns = [
    ...
    path(
        "mailings/<int:pk>/update/", MailingUpdateView.as_view(), name="update"
    ),
    path(
        "mailings/<int:pk>/delete/", MailingDeleteView.as_view(), name="delete"
    ),
    ...
    path(
        "accounts/logout/",
        csrf_exempt(CustomLogoutView.as_view()),
        name="logout",
    ),
