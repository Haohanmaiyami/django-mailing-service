...
class MailingUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if obj.owner != request.user:
            return HttpResponseForbidden("Вы не можете редактировать этот объект.")
...
class ClientUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        if self.get_object().owner != request.user:
            return HttpResponseForbidden("Недостаточно прав для редактирования этого клиента.")
        return super().dispatch(request, *args, **kwargs)
...
class ClientDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def dispatch(self, request, *args, **kwargs):
        if self.get_object().owner != request.user:
            return HttpResponseForbidden("Недостаточно прав для удаления этого клиента.")
        return super().dispatch(request, *args, **kwargs)
